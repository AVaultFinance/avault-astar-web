...
var Toast = function (_a) {
    ...
    return (React__default['default'].createElement(reactTransitionGroup.CSSTransition, __assign({ nodeRef: ref, timeout: 100, style: style }, props),
...
var connectors = [
    ...
    },
    {
        ...
        connectorId: exports.ConnectorNames.UAuthMoralis,
        priority: 2,
        showInstall: false,
    },
    {
...
var WalletCard = function (_a) {
    ...
    return (React__default['default'].createElement(WalletButton, { variant: "tertiary", onClick: function () {
            ...
            onDismiss();
        }, className: "wallet-connect-" + title.toLocaleLowerCase(), id: "wallet-connect-" + title.toLocaleLowerCase() },
        React__default['default'].createElement(Icon, { width: "40px" }),
        React__default['default'].createElement(Text, { fontSize: "15px", fontWeight: "bold" },
            title,
            showInstall ? React__default['default'].createElement("i", { className: "smallText" }, "Install") : null)));
};
...
var ConnectModal = function (_a) {
    ...
    return (React__default['default'].createElement(ModalContainer, { minWidth: "340px" },
        ...
        React__default['default'].createElement(ModalBody, { width: ["340px", null, "480px"] },
            React__default['default'].createElement(WalletWrapper, { maxHeight: "453px", overflowY: "auto" }, displayListConfig.map(function (wallet) { return (React__default['default'].createElement(Box, { key: wallet.title, paddingBottom: "12px" },
                React__default['default'].createElement(WalletCard, { walletConfig: wallet, showInstall: wallet.showInstall, login: login, onDismiss: onDismiss }))); })))));
};
