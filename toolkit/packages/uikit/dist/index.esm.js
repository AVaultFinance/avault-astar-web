...
var WalletCard = function (_a) {
    ...
    return (React.createElement(WalletButton, { variant: "tertiary", onClick: function () {
        ...
        React.createElement(Text, { fontSize: "15px", fontWeight: "bold" },
            title,
            showInstall ? React.createElement("i", { className: "smallText" }, "Install") : null)));
};
...
var ConnectModal = function (_a) {
    ...
    return (React.createElement(ModalContainer, { minWidth: "340px" },
        ...
        React.createElement(ModalBody, { width: ["340px", null, "480px"] },
            React.createElement(WalletWrapper, { maxHeight: "453px", overflowY: "auto" }, displayListConfig.map(function (wallet) { return (React.createElement(Box, { key: wallet.title, paddingBottom: "12px" },
                React.createElement(WalletCard, { walletConfig: wallet, showInstall: wallet.showInstall, login: login, onDismiss: onDismiss }))); })))));
};
