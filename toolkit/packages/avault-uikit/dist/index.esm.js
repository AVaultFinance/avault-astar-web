...
var getDisabledStyles = function (_a) {
    ...
    return "\n    &:disabled,\n    &.pancake-button--disabled {\n      background-color: " + (v === "primary" ? "#F8F8F8" : "#030222") + ";\n      border-color: " + (v === "primary" ? "#F8F8F8" : "#030222") + ";\n      color: " + (v === "primary" ? "#C2C2C2" : "#484E4E") + ";\n      box-shadow: none;\n      cursor: not-allowed;\n    }\n  ";
};
/**
...
var AddBtnIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("g", { fill: "none", fillRule: "evenodd" },
            React.createElement("rect", { stroke: "#E6007A", x: ".5", y: ".5", width: "31", height: "31", rx: "12" }),
            React.createElement("rect", { fill: "#E6007A", x: "8", y: "14", width: "16", height: "4", rx: "2" }))));
};
...
var MinusBtnIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("g", { fill: "none", fillRule: "evenodd" },
            React.createElement("rect", { fill: "#E6007A", width: "32", height: "32", rx: "12" }),
    ...
    return (React.createElement(StyledAlert, null,
        ...
        onClick && (React.createElement(CloseHandler, null,
            React.createElement(IconButton, { scale: "sm", variant: "text", onClick: onClick },
                React.createElement(Icon$1s, { width: "30px", color: "currentColor" }))))));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), additionalColors), { tooltipColors: tooltipColors, background: "#030222", background02: "#030222", backgroundDisabled: "#f1ecef", backgroundAlt: "#181733", cardBorder: "#19183E", cardBackground: "#181733", contrast: "#181733", dropdown: "#1E1D20", dropdownDeep: "#100C18", invertedContrast: "#191326", input: "#fff", inputSecondary: "#262130", tertiary: "#FDFBFB", text: "#FFFFFF", textDisabled: "#37365E", textSubtle: "#6A6991", textSubSubtle: "#C2C2C2", disabled: "#524B63", btnTextColor: "#F7F3F6", btnBgSecondaryColor: "#01100f", gradients: {
...
var ModalCloseButton = function (_a) {
    ...
    return (React.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
        React.createElement(Icon$1s, { color: "#9DA6A6", height: "30px", width: "30px" })));
};
